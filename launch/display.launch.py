...
def generate_launch_description():
    ####### DATA INPUT ##########
    urdf_file = 'fruit_vehicle_arm.urdf'
    xacro_file = "fruit_vehicle_arm.urdf.xacro"
    #xacro_file = "box_bot.xacro"
    package_description = "fruit_vehicle_arm"
    use_urdf = False
    ...
    default_rviz_config_path = PathJoinSubstitution(
        [FindPackageShare("fruit_vehicle_arm"), "rviz", "display_default.rviz"]
    )
